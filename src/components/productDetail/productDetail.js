    ...
    <Fragment >
      <div className="product-detail-header container" >
              ...
              <div className="product-detail-title">
                <h5 className="container">
                  SBS Air Free – TWS wireless earphones with 250 mAh charging case Red
                  Brand: SBS
                  SKU: TEEARAIRFREETWSBTW-1
                </h5>
              </div>
      ...
      <div className="product-detail-container container">
        <div className="product-detail-carousel ">
          ...
          >
            <SwiperSlide>
              <img src="images\Weekly\tws-wireless-earphones-with-250-mah-charging-case_red-2.jpeg" />
            </SwiperSlide>
            <SwiperSlide>
              <img src="images\Weekly\tws-wireless-earphones-with-250-mah-charging-case_red-3.jpeg" />
            </SwiperSlide>
            <SwiperSlide>
              <img src="images\Weekly\tws-wireless-earphones-with-250-mah-charging-case_red-4.jpeg" />
            </SwiperSlide>
            <SwiperSlide>
              <img src="images\Weekly\tws-wireless-earphones-with-250-mah-charging-case_red.jpeg" />
            </SwiperSlide>
